  ...
  return (
    <div className="min-h-screen bg-background">
      <nav className="border-b px-4 py-3">
        <div className="mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Link to="/" className="text-lg font-semibold flex justify-center items-center mr-12">
              <img
          ...
          <div className="flex items-center gap-6">
            ...
            >
              <Button 
                variant="outline" 
                size="sm" 
                className="hidden sm:flex items-center gap-2 hover:bg-[#574a90] hover:text-white hover:border-[#574a90] transition-colors"
              >
      ...
      <Routes>
        ...
        <Route
          path="/login"
          element={user ? <Navigate to="/playground" replace /> : <Auth />}
        />
        <Route
          path="/playground"
          element={
