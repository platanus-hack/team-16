---
title: 'Python SDK'
description: 'Official Python SDK for Scapester API'
---

## Overview

Scapester Python SDK provides a simple wrapper around the Scapester API to help you transform web content into structured data.

## Installation

Install the Scapester Python SDK using pip:
...
<CodeGroup>
  ```python Python
  from scapester.exceptions import ScapesterError, APIError
